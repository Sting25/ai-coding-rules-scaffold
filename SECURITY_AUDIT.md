...
- **Impact:** An attacker who can get any text containing 'scaffold-allow' onto the same physical line as a secret exfiltrates it past the scanner. Even benign-looking lines like `note = "see scaffold-allow ticket"; password = "supersecretvalue1234"` smu…
